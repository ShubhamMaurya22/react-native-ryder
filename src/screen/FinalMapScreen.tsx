...
const FinalMapScreen = ({navigation, route}: any) => {
    ...
    <>
      ...
      <View style={styles.passengerInfo}>
        {passengerData.map((passenger, index) => (
          <View key={index} style={styles.passInfoBox}>
            ...
            <Text style={styles.passName}>{passenger.userName}</Text>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleSendLocation(passenger.phone)}>
      ...
      {passengerData.length == 0 && (
        <View style={styles.noInfo}>
          <Text style={styles.noText}>No Passenger Added</Text>
        </View>
      )}
    </>
  );
